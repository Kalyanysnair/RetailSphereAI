...
export const LoginPage: React.FC = () => {
  return (
    <div className="relative min-h-screen w-full flex flex-col justify-between overflow-y-auto text-[#2C241D] selection:bg-[#48A63E] selection:text-white">
      ...
      {/* Centered Ultra Glassmorphic Login Card */}
      <main className="relative z-10 flex-1 flex items-center justify-center my-6 px-4 py-8">
        <div className="w-full max-w-[380px] sm:max-w-[420px] ultra-glass-panel rounded-[2.5rem] p-7 sm:p-9 shadow-2xl transition-all duration-300 relative">
          <LoginForm />
        </div>
      </main>
