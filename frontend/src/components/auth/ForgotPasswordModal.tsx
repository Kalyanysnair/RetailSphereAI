...
import { X, Mail, Lock, KeyRound, CheckCircle2, ArrowRight, Eye, EyeOff } from 'lucide-react';
...
export const ForgotPasswordModal: React.FC<ForgotPasswordModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/85 backdrop-blur-xl animate-fadeIn">
      <div className="relative w-full max-w-[340px] sm:max-w-[360px] glass-card-exact rounded-[28px] p-6 sm:p-7 shadow-2xl text-white transition-all duration-300">
        ...
        {/* Modal Title matching Login Card Header */}
        ...
        <div className="mt-6 text-center">
          <p className="text-[10px] text-white/60 tracking-wider">
            Created by <span className="font-semibold text-white/80">RetailSphere AI</span>
          </p>
        </div>
      </div>
    </div>
